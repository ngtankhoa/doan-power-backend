...
// Read from .env file for consistent configuration in each build stepsw
require('dotenv').config();
console.log("env/production.js: " + process.env.DATABASE_URL);
...
module.exports = {
  ...
  ***************************************************************************/
  ...
  //   //
  //   //--------------------------------------------------------------------------
  //   // secret: 'ef7db4344f411a292c35f9565b72e50e',
  ...
  ***************************************************************************/
  sockets: {
    ...
    ***************************************************************************/
    onlyAllowOrigins: [
      'https://power.neuraldisplay.xyz',
      'https://staging.power.neuraldisplay.xyz',
    ],
  ...
  ***************************************************************************/
  custom: {
    appName: 'Power Management API',
    baseUrl: 'https://api.power.neuraldisplay.xyz',
    internalEmailAddress: 'support@neuraldisplay.xyz',
